...
@Component({
  selector: 'app-cordova-statusbar',
  templateUrl: './cordova-statusbar.page.html',
  styleUrls: ['./cordova-statusbar.page.scss'],
})
export class CordovaStatusBarPage implements OnInit {
